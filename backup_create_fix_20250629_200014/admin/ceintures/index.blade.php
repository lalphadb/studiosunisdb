...
@section('content')
<div class="space-y-6">
    <!-- Header avec couleurs ceinture -->
    <div class="bg-gradient-to-r from-orange-500 to-red-600 text-white p-6 rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div class="relative z-10 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Gestion des Ceintures</h1>
                    <p class="text-lg opacity-90 font-medium">Gestion de vos ceintures du réseau</p>
                </div>
            </div>
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-400" id="total-count">{{ \App\Models\Ceinture::count() ?? 0 }}</p>
                </div>
            </div>
        </div>
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-400" id="monthly-count">{{ \App\Models\Ceinture::whereMonth('created_at', now()->month)->count() ?? 0 }}</p>
                </div>
            </div>
        </div>
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-yellow-400" id="new-count">{{ \App\Models\Ceinture::whereDate('created_at', today())->count() ?? 0 }}</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-slate-700" id="data-table">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <h3 class="text-lg font-medium text-white mb-2">Module Gestion des Ceintures</h3>
