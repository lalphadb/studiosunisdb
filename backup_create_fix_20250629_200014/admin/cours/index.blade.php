...
@section('content')
<div class="space-y-6">
    <!-- Header avec couleurs cours -->
    <div class="bg-gradient-to-r from-purple-500 to-indigo-600 text-white p-6 rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div class="relative z-10 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-lg opacity-90 font-medium">Gestion de vos cours du réseau</p>
                </div>
            </div>
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-400" id="total-count">{{ \App\Models\Cours::count() ?? 0 }}</p>
                </div>
            </div>
        </div>
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-400" id="monthly-count">{{ \App\Models\Cours::whereMonth('created_at', now()->month)->count() ?? 0 }}</p>
                </div>
            </div>
        </div>
        <div class="bg-slate-800 border border-slate-700 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-yellow-400" id="new-count">{{ \App\Models\Cours::whereDate('created_at', today())->count() ?? 0 }}</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-slate-700" id="data-table">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <h3 class="text-lg font-medium text-white mb-2">Module Gestion des Cours</h3>
