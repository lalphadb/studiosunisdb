            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Validation Rapide</h3>
                        <p class="text-gray-600 mb-6">Interface de validation express pour les paiements</p>
                        
                        <div class="bg-green-50 border border-green-200 rounded-lg p-6 max-w-md mx-auto mb-6">
