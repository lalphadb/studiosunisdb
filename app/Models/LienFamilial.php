...
class LienFamilial extends Model
{
    ...
    /**
     * Relation vers le membre principal
     */
    public function membrePrincipal(): BelongsTo
    {
        return $this->belongsTo(Membre::class, 'membre_principal_id');
    }

    /**
     * Relation vers le membre lié
     */
    public function membreLie(): BelongsTo
    {
        return $this->belongsTo(Membre::class, 'membre_lie_id');
    }
