...
class SessionCoursController extends BaseAdminController
{
    ...
    public function index(Request $request): View
    {
        return $this->executeWithExceptionHandling(function() use ($request) {
            ...
            return view('pages.admin.sessions.index', compact('sessions'));
    ...
    public function show(SessionCours $sessionCours): View
    {
        ...
        return view('pages.admin.sessions.show', compact('sessionCours'));
    }
    ...
    {
        return view('pages.admin.sessions.edit', compact('sessionCours'));
    }
