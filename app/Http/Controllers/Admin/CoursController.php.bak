...
class CoursController extends BaseAdminController
{
    ...
    public function index(Request $request): View
    {
        try {
            ...
            return view('pages.admin.cours.index', compact('cours', 'stats'));
    ...
    public function show(Cours $cours): View
    {
        ...
        try {
            ...
            return view('pages.admin.cours.show', compact('cours'));
    ...
    public function edit(Cours $cours): View
    {
        ...
        return view('pages.admin.cours.edit', compact('cours'));
    }
