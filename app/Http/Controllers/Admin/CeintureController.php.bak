...
class CeintureController extends BaseAdminController
{
    ...
    public function index(Request $request): View
    {
        try {
            ...
            return view('pages.admin.ceintures.index', compact('attributions', 'ceintures', 'stats', 'membres'));
            ...
            return $this->redirectWithError('pages.admin.dashboard', 'Erreur lors du chargement des ceintures');
        }
    }
    ...
    public function create(Request $request): View
    {
        ...
        return view('pages.admin.ceintures.create', compact('user', 'ceintures', 'membres'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('pages.admin.ceintures.index')
    ...
    public function createMasse(): View
    {
        ...
        return view('pages.admin.ceintures.create-masse', compact('ceintures', 'users'));
    }
    ...
    public function edit(UserCeinture $userCeinture): View
    {
        ...
        return view('pages.admin.ceintures.edit', compact('userCeinture', 'ceintures'));
    }
