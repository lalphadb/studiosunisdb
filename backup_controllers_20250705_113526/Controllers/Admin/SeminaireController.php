...
class SeminaireController extends BaseAdminController
{
    ...
    public function index(Request $request): View
    {
        return $this->executeWithExceptionHandling(function() use ($request) {
            ...
            return view('pages.admin.seminaires.index', compact('seminaires'));
    ...
    {
        return view('pages.admin.seminaires.create');
    }
    ...
    {
        return view('pages.admin.seminaires.show', compact('seminaire'));
    }
    ...
    {
        return view('pages.admin.seminaires.edit', compact('seminaire'));
    }
