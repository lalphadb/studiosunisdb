...
<div class="space-y-6">
    ...
    <x-module-header 
        module="presence"
        title="Détails Présences"
        subtitle="Informations détaillées"
        create-route="{{ route('admin.presences.create') }}"
        create-text="Nouveau"
        create-permission="create,App\Models\Presence"
    />
                        ...
                        <div class="bg-slate-700 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-white">
                                        {{ $presence->user->prenom }} {{ $presence->user->nom }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-700 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-white">{{ $presence->user->email }}</p>
                                </div>
                            </div>
                        </div>

                        @if($presence->user->telephone)
                            <div class="bg-slate-700 rounded-lg p-4">
                                <div class="flex items-center">
                                    <i class="fas fa-phone text-2xl text-indigo-400 mr-4"></i>
                                    <div>
                                        <p class="text-sm text-gray-400">Téléphone</p>
                                        <p class="text-lg font-semibold text-white">{{ $presence->user->telephone }}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
