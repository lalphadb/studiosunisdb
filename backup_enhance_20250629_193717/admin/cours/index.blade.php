    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-module-header 
                ...
                subtitle="Gestion des cours du réseau"
                icon="📚"
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg">
                                ...
                                <p class="text-3xl font-bold text-blue-600">{{ \App\Models\Cours::count() ?? 0 }}</p>
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg">
                                ...
                                <div class="space-y-2">
                                    <x-primary-button href="{{ route('admin.cours.create') }}" size="sm" class="w-full justify-center">
                                        ➕ Créer
                                    </x-primary-button>
                    ...
                    <div class="mt-8">
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="font-medium text-blue-900">Module Gestion des Cours</p>
