...
class PresenceController extends BaseAdminController
{
    ...
    public function index(Request $request): View
    {
        return $this->executeWithExceptionHandling(function() use ($request) {
            ...
            return view('pages.admin.presences.index', compact('presences', 'cours', 'stats'));
    ...
    public function create(): View
    {
        ...
        return view('pages.admin.presences.create', compact('cours', 'users'));
    }
    ...
    public function show(Presence $presence): View
    {
        ...
        return view('pages.admin.presences.show', compact('presence'));
    }
    ...
    public function edit(Presence $presence): View
    {
        ...
        return view('pages.admin.presences.edit', compact('presence', 'cours', 'users'));
    }
