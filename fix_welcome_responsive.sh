#!/bin/bash
echo "🔧 CORRECTION PAGE ACCUEIL RESPONSIVE"
echo "===================================="

# Recréer la page welcome avec un design responsive correct
cat > resources/views/welcome.blade.php << 'WELCOME_FIXED'
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="utf-8">
...
<body class="bg-slate-900 text-white">
    ...
    <div class="bg-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <!-- Gradient background contenu dans le container -->
...
echo "✅ Page d'accueil corrigée avec design responsive"
...
echo "La page d'accueil est maintenant responsive et le header ne déborde plus."
echo "Testez: http://127.0.0.1:8001/"
