<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
    ...
    <div class="relative z-10">
      <!-- Header Navigation -->
      <nav class="bg-slate-800/80 backdrop-blur-lg border-b border-slate-700/50">
          ...
          <div class="flex justify-between items-center h-16">
            <div class="flex items-center space-x-4">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <h1 class="text-xl font-bold text-white">StudiosDB v5 Pro</h1>
                  <p class="text-xs text-slate-400">École de Karaté - Dashboard Professionnel</p>
                </div>
              </div>
            </div>
            ...
            <div class="flex items-center space-x-4">
              <div class="text-right">
                ...
                <p class="text-xs text-slate-400">{{ user?.roles?.join(', ') || 'Administrateur' }}</p>
              </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <!-- Total Membres -->
          <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">
            ...
            <div class="space-y-1">
              ...
              <p class="text-sm text-slate-400">Total Membres</p>
              ...
              <p class="text-xs text-slate-500">Objectif: {{ stats?.objectif_membres || 50 }} membres</p>
            </div>
          </div>
          ...
          <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">
            ...
            <div class="space-y-1">
              ...
              <p class="text-xs text-slate-500">Présents cette semaine</p>
            </div>
          </div>
          ...
          <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">
            ...
            <div class="space-y-1">
              ...
              <p class="text-sm text-slate-400">Revenus ce Mois</p>
              <div class="w-full bg-slate-700 rounded-full h-2">
              ...
              <p class="text-xs text-slate-500">Objectif: ${{ stats?.objectif_revenus || 4000 }}</p>
            </div>
          </div>
          ...
          <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
              ...
              <div class="text-sm" :class="(stats?.taux_presence || 87) >= 80 ? 'text-green-400' : 'text-yellow-400'">
                {{ getTauxPresenceLabel(stats?.taux_presence || 87) }}
              </div>
            </div>
            <div class="space-y-1">
              <p class="text-2xl font-bold text-white">{{ stats?.taux_presence || 87 }}%</p>
              <p class="text-sm text-slate-400">Taux de Présence</p>
              <div class="w-full bg-slate-700 rounded-full h-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <a href="/membres" 
             class="group bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl p-6 transition-all duration-300 transform hover:scale-105">
          ...
          <a href="/cours" 
             class="group bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 rounded-xl p-6 transition-all duration-300 transform hover:scale-105">
            <div class="flex items-center justify-between">
              <div>
          ...
          <a href="/presences" 
             class="group bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 rounded-xl p-6 transition-all duration-300 transform hover:scale-105">
            <div class="flex items-center justify-between">
              <div>
          ...
          <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
            ...
            <div class="space-y-4">
              <div class="flex items-center space-x-4 p-3 bg-slate-700/30 rounded-lg">
                ...
                <div class="flex-1">
                  <p class="text-white text-sm font-medium">Nouveau membre inscrit</p>
                  <p class="text-slate-400 text-xs">Marie Dubois - Cours débutant</p>
                </div>
                <span class="text-slate-500 text-xs">Il y a 2h</span>
              </div>
              ...
              <div class="flex items-center space-x-4 p-3 bg-slate-700/30 rounded-lg">
                ...
                <div class="flex-1">
                  <p class="text-white text-sm font-medium">Examen ceinture planifié</p>
                  <p class="text-slate-400 text-xs">6 candidats pour ceinture jaune</p>
                </div>
                <span class="text-slate-500 text-xs">Il y a 4h</span>
              </div>
              ...
              <div class="flex items-center space-x-4 p-3 bg-slate-700/30 rounded-lg">
                ...
                <div class="flex-1">
                  <p class="text-white text-sm font-medium">Paiement reçu</p>
                  <p class="text-slate-400 text-xs">Jean Martin - Abonnement mensuel</p>
                </div>
                <span class="text-slate-500 text-xs">Hier</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="text-center p-4 bg-slate-700/30 rounded-lg">
                <div class="text-2xl font-bold text-blue-400">{{ stats?.examens_ce_mois || 6 }}</div>
                <div class="text-xs text-slate-400">Examens ce mois</div>
              </div>
              
              <div class="text-center p-4 bg-slate-700/30 rounded-lg">
                <div class="text-2xl font-bold text-green-400">{{ stats?.moyenne_age || '26 ans' }}</div>
                <div class="text-xs text-slate-400">Âge moyen</div>
              </div>
              
              <div class="text-center p-4 bg-slate-700/30 rounded-lg">
                <div class="text-2xl font-bold text-yellow-400">{{ stats?.retention_rate || 96 }}%</div>
                <div class="text-xs text-slate-400">Taux rétention</div>
              </div>
              
              <div class="text-center p-4 bg-slate-700/30 rounded-lg">
                <div class="text-2xl font-bold text-purple-400">{{ stats?.satisfaction_moyenne || 94 }}%</div>
            ...
            <div class="mt-6">
              <h4 class="text-sm font-medium text-white mb-3">Répartition Ceintures</h4>
              <div class="space-y-2">
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 bg-white rounded-full"></div>
                    <span class="text-sm text-slate-300">Blanche</span>
                  </div>
                  <span class="text-sm text-slate-400">{{ Math.floor((stats?.total_membres || 42) * 0.4) }}</span>
                </div>
                
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 bg-yellow-400 rounded-full"></div>
                    <span class="text-sm text-slate-300">Jaune</span>
                  </div>
                  <span class="text-sm text-slate-400">{{ Math.floor((stats?.total_membres || 42) * 0.3) }}</span>
                </div>
                
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 bg-orange-500 rounded-full"></div>
                    <span class="text-sm text-slate-300">Orange</span>
                  </div>
                  <span class="text-sm text-slate-400">{{ Math.floor((stats?.total_membres || 42) * 0.2) }}</span>
                </div>
                
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                    <span class="text-sm text-slate-300">Verte+</span>
                  </div>
                  <span class="text-sm text-slate-400">{{ Math.floor((stats?.total_membres || 42) * 0.1) }}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
          <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
              ...
              <button class="px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white rounded-lg text-sm font-medium transition-colors">
                💳 Paiements
              </button>
            </div>
          </div>
