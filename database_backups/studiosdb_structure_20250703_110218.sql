...
CREATE TABLE `ceintures` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ceintures_ecole_id_index` (`ecole_id`),
  CONSTRAINT `ceintures_ecole_id_foreign` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE CASCADE
...
CREATE TABLE `cours` (
  ...
  `nom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `niveau` enum('debutant','intermediaire','avance','tous_niveaux') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `capacite_max` int NOT NULL DEFAULT '20',
  `prix` decimal(8,2) DEFAULT NULL,
  `duree_minutes` int NOT NULL DEFAULT '60',
  `instructeur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `cours_horaires` (
  ...
  `instructeur_affecte` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `capacite_max` int DEFAULT '20',
  `prix` decimal(8,2) DEFAULT NULL,
  `nom_affiche` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cours_horaires_cours_id_foreign` (`cours_id`),
  KEY `idx_ecole_id` (`ecole_id`),
  KEY `idx_session_id` (`session_id`),
  KEY `idx_session_active` (`session_id`,`active`),
  KEY `idx_cours_session` (`cours_id`,`session_id`),
  KEY `idx_ecole_jour` (`ecole_id`,`jour_semaine`),
  CONSTRAINT `cours_horaires_cours_id_foreign` FOREIGN KEY (`cours_id`) REFERENCES `cours` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cours_horaires_ibfk_1` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cours_horaires_ibfk_2` FOREIGN KEY (`session_id`) REFERENCES `sessions_cours` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ecoles` (
  ...
  `province` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'QC',
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `proprietaire` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `inscriptions_cours` (
  ...
  `ecole_id` bigint unsigned NOT NULL,
  `cours_id` bigint unsigned NOT NULL,
  `cours_horaire_id` bigint unsigned DEFAULT NULL,
  `session_id` bigint unsigned DEFAULT NULL,
  `date_inscription` date NOT NULL DEFAULT '2025-06-22',
  `statut` enum('inscrit','confirme','annule') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inscrit',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `frequence` enum('1x_semaine','2x_semaine') COLLATE utf8mb4_unicode_ci DEFAULT '1x_semaine',
  `prix_paye` decimal(8,2) DEFAULT NULL,
  `horaires_choisis` json DEFAULT NULL,
  `reinscription` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `inscriptions_cours_user_id_cours_id_unique` (`user_id`,`cours_id`),
  KEY `inscriptions_cours_cours_id_foreign` (`cours_id`),
  KEY `idx_ecole_id` (`ecole_id`),
  KEY `idx_cours_horaire_id` (`cours_horaire_id`),
  KEY `idx_session_id` (`session_id`),
  KEY `idx_session_statut` (`session_id`,`statut`),
  KEY `idx_user_session` (`user_id`,`session_id`),
  KEY `idx_ecole_session` (`ecole_id`,`session_id`),
  CONSTRAINT `inscriptions_cours_cours_id_foreign` FOREIGN KEY (`cours_id`) REFERENCES `cours` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inscriptions_cours_ibfk_1` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inscriptions_cours_ibfk_2` FOREIGN KEY (`cours_horaire_id`) REFERENCES `cours_horaires` (`id`) ON DELETE SET NULL,
  CONSTRAINT `inscriptions_cours_ibfk_3` FOREIGN KEY (`session_id`) REFERENCES `sessions_cours` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inscriptions_cours_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `inscriptions_historique`
--

DROP TABLE IF EXISTS `inscriptions_historique`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `inscriptions_historique` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `ecole_id` bigint unsigned NOT NULL,
  `session_id` bigint unsigned NOT NULL,
  `cours_choisis` json NOT NULL,
  `montant_total` decimal(8,2) NOT NULL,
  `statut` enum('active','terminee','annulee') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `date_inscription` timestamp NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `inscriptions_historique_ecole_id_foreign` (`ecole_id`),
  KEY `inscriptions_historique_user_id_ecole_id_index` (`user_id`,`ecole_id`),
  KEY `inscriptions_historique_session_id_statut_index` (`session_id`,`statut`),
  CONSTRAINT `inscriptions_historique_ecole_id_foreign` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inscriptions_historique_session_id_foreign` FOREIGN KEY (`session_id`) REFERENCES `sessions_cours` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inscriptions_historique_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inscriptions_seminaires` (
  ...
  `date_inscription` date NOT NULL DEFAULT '2025-06-22',
  `statut` enum('inscrit','confirme','present','absent','annule') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inscrit',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `paiements` (
  ...
  `reference_interne` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_paiement` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'interac',
  `motif` enum('session_automne','session_hiver','session_printemps','session_ete','seminaire','examen_ceinture','equipement','autre') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `reference_interac` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_interac` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `periode_facturation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `presences` (
  ...
  CONSTRAINT `presences_ibfk_1` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `seminaires` (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type` enum('technique','kata','competition','arbitrage') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_debut` date NOT NULL,
  `date_fin` date NOT NULL,
  `heure_debut` time NOT NULL,
  `heure_fin` time NOT NULL,
  `lieu` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse_lieu` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ville_lieu` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instructeur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prix` decimal(8,2) DEFAULT NULL,
  `niveau_requis` enum('debutant','intermediaire','avance','tous_niveaux') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `inscription_ouverte` tinyint(1) NOT NULL DEFAULT '1',
  `statut` enum('planifie','ouvert','complet','termine','annule') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'planifie',
  `certificat` tinyint(1) NOT NULL DEFAULT '0',
  `materiel_requis` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `seminaires_processed_by_user_id_foreign` (`processed_by_user_id`),
  KEY `seminaires_ecole_id_statut_index` (`ecole_id`,`statut`),
  CONSTRAINT `seminaires_ecole_id_foreign` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE SET NULL,
  CONSTRAINT `seminaires_processed_by_user_id_foreign` FOREIGN KEY (`processed_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `session_notifications` (
  ...
  `session_id` bigint unsigned NOT NULL,
  `ecole_id` bigint unsigned NOT NULL,
  `type` enum('ouverture','rappel_3j','rappel_1j','fermeture') COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_envoi` timestamp NULL DEFAULT NULL,
  `membres_notifies` int NOT NULL DEFAULT '0',
  `envoye` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `session_notifications_ecole_id_foreign` (`ecole_id`),
  KEY `session_notifications_session_id_type_index` (`session_id`,`type`),
  KEY `session_notifications_date_envoi_envoye_index` (`date_envoi`,`envoye`),
  CONSTRAINT `session_notifications_ecole_id_foreign` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `session_notifications_session_id_foreign` FOREIGN KEY (`session_id`) REFERENCES `sessions_cours` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sessions_cours`
--
...
CREATE TABLE `sessions_cours` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ecole_id` (`ecole_id`),
  CONSTRAINT `sessions_cours_ibfk_1` FOREIGN KEY (`ecole_id`) REFERENCES `ecoles` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22142 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_ceintures`
--
...
CREATE TABLE `user_ceintures` (
  ...
  `date_attribution` date NOT NULL DEFAULT '2025-07-01',
  `attribue_par` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_obtention` date NOT NULL,
  `examinateur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `validation_officielle` tinyint(1) NOT NULL DEFAULT '0',
  `certificat_numero` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `instructeur_id` bigint unsigned DEFAULT NULL,
  `examen_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ecole_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_user_ecole` (`user_id`,`ecole_id`),
  KEY `idx_ecole_date` (`ecole_id`,`date_attribution`),
...
CREATE TABLE `users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_famille` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nom de famille groupé',
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `ecole_id` bigint unsigned DEFAULT NULL,
  `telephone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_principal_famille` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Contact principal de la famille',
  `telephone_principal_famille` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `date_inscription` date NOT NULL DEFAULT '2025-06-22',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `notes_famille` text COLLATE utf8mb4_unicode_ci COMMENT 'Notes famille partagées',
...
-- Dump completed on 2025-07-03 11:02:28
