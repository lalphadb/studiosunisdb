            ...
            >
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-2 md:ml-3 min-w-0">
                    ...
                    <div class="text-xs text-slate-400">
                      {{ user.age }} ans
                      <span v-if="user.is_minor" class="ml-1 text-amber-400 font-medium">(M)</span>
                    </div>
                  </div>
                </div>
              </td>
              <td class="px-2 md:px-3 py-3 md:py-4 whitespace-nowrap hidden sm:table-cell max-w-[120px] md:max-w-none">
                <div class="text-sm text-slate-300 truncate">{{ user.user?.email || '—' }}</div>
                <div class="text-xs text-slate-500 truncate">{{ user.telephone || '—' }}</div>
              </td>
              <td class="px-2 md:px-3 py-3 md:py-4 whitespace-nowrap">
                <span
                  v-if="user.ceinture_actuelle"
                  class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium truncate max-w-[80px] md:max-w-none"
                  :style="{
                    backgroundColor: user.ceinture_actuelle.couleur_hex + '30',
                    color: user.ceinture_actuelle.couleur_hex,
                    border: `1px solid ${user.ceinture_actuelle.couleur_hex}50`
                  }"
                  :title="user.ceinture_actuelle.nom"
                >
              ...
              <td class="px-2 md:px-3 py-3 md:py-4 whitespace-nowrap hidden lg:table-cell">
                <span
                  ...
                  :class="{
                    'bg-green-500/20 text-green-400 border border-green-500/30': user.statut === 'actif',
                    'bg-slate-500/20 text-slate-400 border border-slate-500/30': user.statut === 'inactif',
                    'bg-red-500/20 text-red-400 border border-red-500/30': user.statut === 'suspendu'
                  }"
                >
              ...
              <td class="px-2 md:px-3 py-3 md:py-4 whitespace-nowrap text-center hidden md:table-cell">
                <div class="text-sm text-slate-400">{{ user.presences_mois || 0 }}</div>
