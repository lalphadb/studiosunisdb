          ...
          <table class="w-full">
            <thead>
              <tr class="bg-slate-900/50 border-b border-slate-700/50">
                <th class="px-3 py-4 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">
                  Membre
                </th>
                <th class="px-2 py-4 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider w-40">
                  Contact
                </th>
                <th class="px-2 py-4 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider w-28">
                  Ceinture
                </th>
                <th class="px-2 py-4 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider w-20">
                  Statut
                </th>
                <th class="px-2 py-4 text-center text-xs font-semibold text-slate-400 uppercase tracking-wider w-16">
                  Cours
                </th>
                <th class="px-2 py-4 text-center text-xs font-semibold text-slate-400 uppercase tracking-wider w-20">
                  Présences
                </th>
                <th class="px-2 py-4 text-right text-xs font-semibold text-slate-400 uppercase tracking-wider w-24">
                  Actions
                </th>
              </tr>
            </thead>
              ...
              >
                <td class="px-3 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    ...
                    <div class="ml-3">
                      <div class="text-sm font-medium text-white truncate max-w-32">
                        {{ membre.nom_complet }}
                      </div>
                ...
                <td class="px-2 py-4 whitespace-nowrap">
                  <div class="text-sm text-slate-300 truncate max-w-36">{{ membre.user?.email }}</div>
                  <div class="text-xs text-slate-500 truncate">{{ membre.telephone }}</div>
                </td>
                <td class="px-2 py-4 whitespace-nowrap">
                  <span
                    v-if="membre.ceinture_actuelle"
                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium truncate max-w-24"
                    :style="{
                ...
                <td class="px-2 py-4 whitespace-nowrap text-sm text-slate-400 text-center">
