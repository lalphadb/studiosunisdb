                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-white">{{ $users->count() }}</p>
                        </div>
                    </div>
                    <div class="flex items-center">
                    ...
                    @if($users->count() > 0)
                        <div class="divide-y divide-slate-700">
                            @foreach($users as $index => $user)
                                @php
                                    $presenceExistante = $presencesExistantes->get($user->id);
                                ...
                                <div class="p-4 hover:bg-slate-700 transition-colors duration-150">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <input type="hidden" name="presences[{{ $index }}][user_id]" value="{{ $user->id }}">
                        ...
                        <div class="p-6 bg-slate-700 border-t border-slate-600">
                            <div class="flex justify-between items-center">
                                <div class="text-sm text-gray-400">
                                    {{ $users->count() }} membre(s) dans ce cours
                                </div>
