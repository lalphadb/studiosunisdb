<footer class="bg-slate-800 border-t border-slate-700 px-6 py-3" role="contentinfo">
    <div class="flex flex-col sm:flex-flex flex-wrap -mx-2 justify-between items-center text-xs text-slate-400 space-y-2 sm:space-y-0">
        <div class="flex flex-col sm:flex-flex flex-wrap -mx-2 items-center space-y-1 sm:space-y-0 sm:space-x-4">
    ...
    <div class="mt-2 pt-2 border-t border-slate-700/50 text-center">
        <div class="flex flex-col sm:flex-flex flex-wrap -mx-2 justify-center items-center space-y-1 sm:space-y-0 sm:space-x-6 text-xs text-slate-500">
