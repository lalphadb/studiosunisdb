...
<div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <p class="text-lg text-emerald-100 font-medium">{{ $ecole?->nom ?? 'École' }}</p>
        ...
        <div class="space-y-4">
            ...
            @empty
                <div class="text-center py-8 text-slate-400">
                    <span class="text-slate-500 text-4xl mb-4 block">👥</span>
        ...
        <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6 group hover:border-violet-500/30 transition-colors">
            <div class="text-center">
                <div class="w-16 h-16 bg-violet-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-violet-500/30 transition-colors">
                    <span class="text-violet-400 text-2xl">📚</span>
                </div>
    ...
    <!-- Mes Cours -->
    @if(($prochains_cours ?? collect([]))->count() > 0)
    <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center space-x-3">
                <span class="text-violet-400 text-xl">📚</span>
    ...
    <div class="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-6">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-emerald-300 text-sm">Vous gérez l'école "<strong>{{ $ecole?->nom ?? 'École' }}</strong>". Cette interface vous donne accès à tous les outils de gestion de votre établissement.</p>
            </div>
        </div>
    </div>
</div>
