            ...
            <div class="bg-white overflow-hidden shadow-md rounded-xl">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <button class="btn-primary" href="{{ route('admin.users.create') }}" class="justify-center py-4">
                            👤 Nouvel Utilisateur
                        </button>
                        <button class="btn-primary" href="{{ route('admin.ecoles.create') }}" variant="green" class="justify-center py-4">
                            🏫 Nouvelle École
                        </button>
                        <button class="btn-primary" href="{{ route('admin.cours.create') }}" variant="purple" class="justify-center py-4">
                            📚 Nouveau Cours
                        </button>
                        <button class="btn-primary" href="{{ route('admin.seminaires.create') }}" variant="indigo" class="justify-center py-4">
                            🎯 Nouveau Séminaire
                        </button>
                    </div>
                </div>
