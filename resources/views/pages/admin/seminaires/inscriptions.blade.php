                ...
                <div class="p-6">
                    <div class="text-center py-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-md mx-auto">
                            <button class="btn-primary" href="{{ route('admin.seminaires.index') }}" class="justify-center">
                                📋 Liste des séminaires
                            </button>
                            <button class="btn-secondary" href="{{ route('admin.seminaires.create') }}" class="justify-center">
                                ➕ Nouveau séminaire
                            </button>
                        </div>
                    </div>
