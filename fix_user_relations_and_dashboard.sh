#!/bin/bash
echo "🔧 CORRECTION RELATIONS USER ET DASHBOARD"
echo "========================================="

# 1. Corriger le modèle User avec la relation ceinture_actuelle
echo "📝 1. Correction modèle User..."

# Ajouter la relation manquante dans le modèle User
if ! grep -q "ceinture_actuelle" app/Models/User.php; then
    # Trouver la ligne avec les relations et ajouter la nouvelle relation
    sed -i '/public function ecole()/a\
\
    /**\
    ...
    echo "✅ Relation ceinture_actuelle ajoutée au modèle User"
else
    echo "✅ Relation ceinture_actuelle déjà présente"
fi

# 2. Corriger la vue show de l'utilisateur
echo ""
echo "📝 2. Création vue users/show.blade.php..."

cat > resources/views/admin/users/show.blade.php << 'USER_SHOW'
...
echo "✅ Vue users/show créée"

# 3. Améliorer le dashboard admin avec Telescope
echo ""
echo "📝 3. Amélioration dashboard admin..."

cat > resources/views/admin/dashboard/index.blade.php << 'ADMIN_DASHBOARD'
@extends('layouts.admin')
...
echo "✅ Dashboard admin amélioré avec Telescope"
...
echo "• ✅ Relation ceinture_actuelle ajoutée au modèle User"
echo "• ✅ Vue users/show créée avec tous les détails"
echo "• ✅ Dashboard admin avec modules et outils séparés"
echo "• ✅ Section Telescope pour les superadmins"
